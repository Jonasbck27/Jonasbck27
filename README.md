# 🌏 About Me:
I am Jonas, also known as Quoboo, and interested in programming.<br>I have tried several languages such as HTML5, CSS3, or JS, and I'm currently learning Java.<br><br>In my free time, I like to go karting.<br>Besides, I still going to school and being taught in the field of computer science.<br>My favorite food is pizza and mom's specialties, and I used to have a dog, I am still a big animal lover.<br><br>My current project is Lumania, which I lead myself.<br>We work with individual 3D model data and take Minecraft to a new level.<br><br>Funfact: I love playing chess and enjoy testing my "strategic skills" against other players.


## 🎏 Socials:
[![Discord](https://img.shields.io/badge/Discord-%237289DA.svg?logo=discord&logoColor=white)](https://discord.gg/https://discord.gg/9YpgvRYThk)  [![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/J4_nas)
